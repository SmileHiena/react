        ...
        <>
            <html lang="en">
                <head>
                    ...
                    <link
                        rel="icon"
                        href="assets1/img/kaiadmin/favicon.ico"
                        type="image/x-icon"
                    />


                    <script src="assets1/js/plugin/webfont/webfont.min.js"></script>
                    <script src="assets1/js/Test"></script>
